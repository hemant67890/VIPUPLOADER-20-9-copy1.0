...
try: 
    ADMINS=[] 
    for x in (os.environ.get("ADMINS", "2052075731 7246728595").split()):  
        ADMINS.append(int(x)) 
except ValueError: 
...
bot = Client("bot",    
   bot_token="7634675989:AAFb6gb1M2nS8565st6NTgVbgjvgVNEpbkU",    
   api_id= 26512964,    
...
@bot.on_message(filters.command(["tarain"]))    
async def account_login(bot: Client, m: Message):    
