...
bot = Client("bot",    
   bot_token="7806457322:AAE42L9KgSuYrLqx1QFWf0HGaPQQMIZc5qU",    
   api_id= 26512964,    
...
async def account_login(bot: Client, m: Message):    
    editable = await m.reply_text('**🙏𝗝⃠ᴀɪ 𝗦⃠ʜʀᴇᴇ 𝗥⃠ᴀᴍ🙏\n📝 ꜱᴇɴᴅ ᴛxᴛ ꜰɪʟᴇ ꜰᴏʀ ᴅᴏᴡɴʟᴏᴀᴅ**\n🙏𝗝⃠ᴀɪ 𝗦⃠ʜʀᴇᴇ 𝗥⃠ᴀᴍ🙏')
